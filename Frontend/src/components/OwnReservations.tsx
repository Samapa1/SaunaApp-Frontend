...
//               const dateObj = DateTime.fromISO(isoDate);
//               const weekday = dateObj.weekday; // 1-7 (Monday-Sunday)
//               const finnishDays = ['Ma', 'Ti', 'Ke', 'To', 'Pe', 'La', 'Su'];
//               const dayName = weekday >= 1 && weekday <= 7 ? finnishDays[weekday - 1] : 'N/A';
//               const formattedDate = `${dayName} ${day}.${month}.${year}`;

//               const handleDeleteClick = () => {
//                 setReservedHour(hours);
//                 setReservedDate(formattedDate);
//                 setSelectedSaunaId(reservation.Id);
//                 setShowDeleteReservation(true);
//               };

//               return (
//                 <li key={index} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
//                   Sauna {reservation.Id} {formattedDate} klo {hours}
//                   <Button 
//                     variant="danger" 
//                     size="sm"
